...
echo('          </th>' . "\n");
echo('          <td>' . "\n");
echo('            <input id="id_messageurl" type="url" aria-required="true" value="' . esc_attr($tool->messageUrl) . '" name="messageurl" class="large-text">' . "\n");
echo('          </td>' . "\n");
echo('        </tr>' . "\n");
echo('        <tr>' . "\n");
echo('          <th scope="row">' . "\n");
...
echo('          </th>' . "\n");
echo('          <td>' . "\n");
echo('            <input id="id_contentitemurl" type="url" value="' . esc_attr($tool->contentItemUrl) . '" name="contentitemurl" class="large-text">' . "\n");
...
echo('          </th>' . "\n");
echo('          <td>' . "\n");
echo('            <textarea id="id_custom" name="custom" class="large-text">' . esc_textarea(str_replace('&#13;&#10;', "\r\n",
...
echo('          </th>' . "\n");
echo('          <td>' . "\n");
echo('            <textarea id="id_redirectionuris" name="redirectionuris" class="large-text">');
